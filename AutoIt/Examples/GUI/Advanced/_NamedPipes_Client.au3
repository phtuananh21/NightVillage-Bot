...
Global $g_idEdit, $g_idMemo, $g_idBtn_Send, $g_idEdt_Server, $g_hPipe
...
Func CreateGUI()
	...
	$g_idEdt_Server = GUICtrlCreateEdit("<local>", 56, 10, 200, 20, $SS_LEFT)
	GUICtrlCreateLabel("Command:", 2, 36, 52, 20, $SS_RIGHT)
	$g_idEdit = GUICtrlCreateEdit($DEFCMD, 56, 32, 370, 20, $SS_LEFT)
	$g_idBtn_Send = GUICtrlCreateButton("Send", 430, 32, 60, 20)
...
Func OpenPipe()
	Local $sName, $sPipe
	; Get pipe handle
	$sName = GUICtrlRead($g_idEdt_Server)
