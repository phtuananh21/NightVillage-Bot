...
Global $g_idEdt_GUI = GUICtrlCreateEdit("Debug Log:" & @CRLF, 10, 10, 600, 400)
...
If @error Then
	GUICtrlSetData($g_idEdt_GUI, "ObjEvent error: " & @error & @CRLF, "append")
Else
	GUICtrlSetData($g_idEdt_GUI, "ObjEvent created Successfully!" & @CRLF, "append")
	...
	GUICtrlSetData($g_idEdt_GUI, "You have 10 seconds speaking time now...open your microphone and say something !" & @CRLF, "append")
	Sleep(10000)
...
GUICtrlSetData($g_idEdt_GUI, @CRLF & "End of dictation time." & @CRLF, "append")
GUICtrlSetData($g_idEdt_GUI, "You may close this window now !" & @CRLF, "append")
...
Func MYEvent_StartStream($iStreamNumber, $vStreamPosition)
	...
	GUICtrlSetData($g_idEdt_GUI, "StartStream(): StreamNumber is:" & $iStreamNumber & @CRLF, "append")
...
Func MYEvent_Hypothesis($iStreamNumber, $vStreamPosition, $iResult)
	...
	GUICtrlSetData($g_idEdt_GUI, "Hypothesis(): Hypothized text is: " & $iResult.PhraseInfo.GetText & @CRLF, "append")
...
Func MYEvent_Interference($iStreamNumber, $vStreamPosition, $vInterference)
	...
	GUICtrlSetData($g_idEdt_GUI, "Interference(): StreamNumber is:" & $iStreamNumber & @CRLF, "append")
...
Func MYEvent_Recognition($iStreamNumber, $vStreamPosition, $vRecognitionType, $iResult)
	...
	GUICtrlSetData($g_idEdt_GUI, "Recognition(): Recognized text is: " & $iResult.PhraseInfo.GetText & @CRLF, "append")
...
Func MYEvent_SoundEnd($iStreamNumber, $vStreamPosition)
	...
	;GUICtrlSetData ( $g_idEdt_GUI, "SoundEnd(): StreamNumber is:" & $iStreamNumber & @CRLF  , "append" )
...
Func MYEvent_EndStream($iStreamNumber, $vStreamPosition, $bStreamReleased)
	...
	; GUICtrlSetData ( $g_idEdt_GUI, "EndStream(): StreamNumber is:" & $iStreamNumber & @CRLF  , "append" )
	; GUICtrlSetData ( $g_idEdt_GUI, "EndStream(): StreamReleased is:" & $bStreamReleased & @CRLF  , "append" )
...
Func MYEvent_SoundStart($iStreamNumber, $vStreamPosition)
	...
	;GUICtrlSetData ( $g_idEdt_GUI, "SoundStart(), StreamNumber is: " & $iStreamNumber & @CRLF  , "append" )
	;GUICtrlSetData ( $g_idEdt_GUI, "SoundStart(): StreamPosition is:" & $vStreamPosition & @CRLF  , "append" )
...
Func MYEvent_PhraseStart($iStreamNumber, $vStreamPosition)
	...
	;GUICtrlSetData ( $g_idEdt_GUI, "PhraseStart(): StreamNumber is:" & $iStreamNumber & @CRLF  , "append" )
