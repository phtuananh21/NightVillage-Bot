...
Global $g_idEdt_GUI = GUICtrlCreateEdit("Test Log:" & @CRLF, 10, 10, 600, 400)
...
GUICtrlSetData($g_idEdt_GUI, @CRLF & "End of Internet Explorer Events test." & @CRLF, "append")
...
Func IEEvent_StatusTextChange($sText)
	GUICtrlSetData($g_idEdt_GUI, "IE Status text changed to: " & $sText & @CRLF, "append")
EndFunc   ;==>IEEvent_StatusTextChange

Func IEEvent_PropertyChange($sProperty)
	GUICtrlSetData($g_idEdt_GUI, "IE Changed the value of the property: " & $sProperty & @CRLF, "append")
EndFunc   ;==>IEEvent_PropertyChange

Func IEEvent_DownloadBegin()
	GUICtrlSetData($g_idEdt_GUI, "IE has started a navigation operation" & @CRLF, "append")
EndFunc   ;==>IEEvent_DownloadBegin

Func IEEvent_DownloadComplete()
	GUICtrlSetData($g_idEdt_GUI, "IE has finished a navigation operation" & @CRLF, "append")
...
Func IEEvent_NavigateComplete2($oWebBrowser, $sURL)
	...
	GUICtrlSetData($g_idEdt_GUI, "IE has finished loading URL: " & $sURL & @CRLF, "append")
