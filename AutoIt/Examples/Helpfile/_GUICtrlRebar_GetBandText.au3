...
Func Example()
	Local $hGui = GUICreate("Rebar Get/Set Band Text (v" & @AutoItVersion & ")", 400, 396, -1, -1, BitOR($WS_MINIMIZEBOX, $WS_CAPTION, $WS_POPUP, $WS_SYSMENU, $WS_MAXIMIZEBOX))
	...
	For $x = 0 To _GUICtrlRebar_GetBandCount($hReBar) - 1
		_MemoWrite("Band Index " & $x & @TAB & "Text: " & _GUICtrlRebar_GetBandText($hReBar, $x))
		_MemoWrite("============================================")
	Next
