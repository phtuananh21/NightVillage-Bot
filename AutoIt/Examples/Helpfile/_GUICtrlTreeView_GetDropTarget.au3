...
Func Example()
	GUICreate("TreeView Get/Set Drop Target (v" & @AutoItVersion & ")", 400, 300)
	...
	MsgBox($MB_SYSTEMMODAL, "Information", StringFormat("Item %d Drop Target? %s", $hRandomItem, _GUICtrlTreeView_GetDropTarget($idTreeView, $aidTVi_Item[$hRandomItem])))
