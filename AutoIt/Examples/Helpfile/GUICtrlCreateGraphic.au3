...
Global $g_a_idGrc_Array[$g_MAXGr + 1] ; 0 and $g_MAXGr entries not used to allow GUICtrlDelete result
Global $g_idBtn_Del
...
Func Example()
	...
	Do
		...
		EndIf
		If $idMsg > 0 Then MsgBox($MB_SYSTEMMODAL, "clicked", $idMsg & @CRLF & $g_a_idGrc_Array[5], 2)
