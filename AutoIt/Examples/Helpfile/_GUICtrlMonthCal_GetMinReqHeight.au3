...
Func Example()
	...
	_MemoWrite("Minimum required height: " & _GUICtrlMonthCal_GetMinReqHeight($idMonthCal))
	_MemoWrite("Minimum required width : " & _GUICtrlMonthCal_GetMinReqWidth($idMonthCal))
