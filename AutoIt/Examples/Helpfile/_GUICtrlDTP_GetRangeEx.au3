...
Func Example()
	; Create GUI
	GUICreate("DateTimePick Get RangeEx (v" & @AutoItVersion & ")", 400, 300)
	...
	_MemoWrite("Minimum date: " & GetDateStr("Min"))
	_MemoWrite("Maximum date: " & GetDateStr("Max"))
	_MemoWrite("Minimum time: " & GetTimeStr("Min"))
	_MemoWrite("Maximum time: " & GetTimeStr("Max"))
