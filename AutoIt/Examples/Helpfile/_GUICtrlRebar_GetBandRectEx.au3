...
Func Example()
	...
	For $x = 0 To _GUICtrlRebar_GetBandCount($hReBar) - 1
		...
		_MemoWrite("Band Index " & $x)
		_MemoWrite("==== Band Borders ====")
		_MemoWrite("Left..: " & DllStructGetData($tBorders, "Left"))
		_MemoWrite("Top...: " & DllStructGetData($tBorders, "Top"))
		_MemoWrite("Right.: " & DllStructGetData($tBorders, "Right"))
		_MemoWrite("Bottom: " & DllStructGetData($tBorders, "Bottom"))
		_MemoWrite("======================")
		$tBorders = _GUICtrlRebar_GetBandRectEx($hReBar, $x)
		_MemoWrite("====== Band Rect =====")
		_MemoWrite("Left..: " & DllStructGetData($tBorders, "Left"))
		_MemoWrite("Top...: " & DllStructGetData($tBorders, "Top"))
		_MemoWrite("Right.: " & DllStructGetData($tBorders, "Right"))
		_MemoWrite("Bottom: " & DllStructGetData($tBorders, "Bottom"))
