...
Func Example()
	...
	_MemoWrite("==== Band Margins ====")
	_MemoWrite("===================================")
	_MemoWrite("Minimum OS -> Win XP")
	_MemoWrite("Margins are set Depending on Themes")
	_MemoWrite("===================================")
	_MemoWrite("Left Width.........: " & DllStructGetData($tMargins, "cxLeftWidth"))
	_MemoWrite("Right Width........: " & DllStructGetData($tMargins, "cxRightWidth"))
	_MemoWrite("Top Height.........: " & DllStructGetData($tMargins, "cyTopHeight"))
	_MemoWrite("Bottom Height......: " & DllStructGetData($tMargins, "cyBottomHeight"))
	_MemoWrite("======================")
