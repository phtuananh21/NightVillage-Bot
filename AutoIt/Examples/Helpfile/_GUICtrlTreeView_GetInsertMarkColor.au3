...
Func Example()
	...
	GUICreate("TreeView Get/Set Insert Mark Colo (v" & @AutoItVersion & ")r", 400, 300)
	...
	MsgBox($MB_SYSTEMMODAL, "Information", "Insert Mark Color: 0x" & Hex(_GUICtrlTreeView_GetInsertMarkColor($idTreeView)))
