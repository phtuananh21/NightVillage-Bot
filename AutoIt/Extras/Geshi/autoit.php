...
$language_data = array (
    ...
    'KEYWORDS' => array(
        ...
        4 => array(
            'Array1DToHistogram','Array2DCreate','ArrayAdd','ArrayBinarySearch',
            'ArrayColDelete','ArrayColInsert','ArrayCombinations',
            'ArrayConcatenate','ArrayDelete','ArrayDisplay','ArrayExtract',
            'ArrayFindAll','ArrayFromString','ArrayInsert','ArrayMax',
            'ArrayMaxIndex','ArrayMin','ArrayMinIndex','ArrayPermute',
            'ArrayPop','ArrayPush','ArrayReverse','ArraySearch','ArrayShuffle',
            ...
            'DebugReport','DebugReportData','DebugReportEx','DebugReportVar',
            'DebugSetup','Degree','Div','EventLog__Backup','EventLog__Clear',
            'EventLog__Close','EventLog__Count','EventLog__DeregisterSource',
            'EventLog__Full','EventLog__Notify','EventLog__Oldest',
            'EventLog__Open','EventLog__OpenBackup','EventLog__Read',
            'EventLog__RegisterSource','EventLog__Report','Excel_BookAttach',
            'Excel_BookClose','Excel_BookList','Excel_BookNew','Excel_BookOpen',
            ...
            'FileWriteToLine','FormatAutoItExitCode','FormatAutoItExitMethod',
            'FTP_Close','FTP_Command','FTP_Connect','FTP_DecodeInternetStatus',
            'FTP_DirCreate','FTP_DirDelete','FTP_DirGetCurrent',
            'FTP_DirPutContents','FTP_DirSetCurrent','FTP_FileClose',
            'FTP_FileDelete','FTP_FileGet','FTP_FileGetSize','FTP_FileOpen',
            'FTP_FilePut','FTP_FileRead','FTP_FileRename',
            ...
            'GUICtrlEdit_SetModify','GUICtrlEdit_SetPadding',
            'GUICtrlEdit_SetPasswordChar','GUICtrlEdit_SetReadOnly',
            'GUICtrlEdit_SetRECT','GUICtrlEdit_SetRECTEx',
            'GUICtrlEdit_SetRECTNP','GUICtrlEdit_SetRectNPEx',
            'GUICtrlEdit_SetSel','GUICtrlEdit_SetTabStops',
            'GUICtrlEdit_SetText','GUICtrlEdit_ShowBalloonTip',
            'GUICtrlEdit_Undo','GUICtrlHeader_AddItem',
            'GUICtrlHeader_ClearFilter','GUICtrlHeader_ClearFilterAll',
            'GUICtrlHeader_Create','GUICtrlHeader_CreateDragImage',
            'GUICtrlHeader_DeleteItem','GUICtrlHeader_Destroy',
            'GUICtrlHeader_EditFilter','GUICtrlHeader_GetBitmapMargin',
            'GUICtrlHeader_GetFilterText','GUICtrlHeader_GetImageList',
            ...
            'GUICtrlListView_SetBkHBITMAP','GUICtrlListView_SetBkImage',
            'GUICtrlListView_SetCallBackMask','GUICtrlListView_SetColumn',
            'GUICtrlListView_SetColumnOrder',
            ...
            'GUICtrlTreeView_GetLastChild','GUICtrlTreeView_GetLastItem',
            'GUICtrlTreeView_GetLineColor','GUICtrlTreeView_GetNext',
            'GUICtrlTreeView_GetNextChild','GUICtrlTreeView_GetNextSibling',
            'GUICtrlTreeView_GetNextVisible',
            ...
            'INetSmtpMail','IsPressed','Max','MemGlobalAlloc','MemGlobalFree',
            'MemGlobalLock','MemGlobalReAlloc','MemGlobalSize',
            'MemGlobalUnlock','MemMoveMemory','MemVirtualAlloc',
            'MemVirtualAllocEx','MemVirtualFree','MemVirtualFreeEx','Min',
            'MouseTrap','NamedPipes_CallNamedPipe',
            ...
            'SQLite_FetchData','SQLite_FetchNames','SQLite_ForeignKeys',
            'SQLite_GetTable','SQLite_GetTable2D','SQLite_GetTableData2D',
            'SQLite_LastInsertRowID','SQLite_LibVersion','SQLite_Open',
            'SQLite_Query','SQLite_QueryFinalize','SQLite_QueryReset',
            'SQLite_QuerySingleRow','SQLite_SafeMode','SQLite_SetTimeout',
            'SQLite_Shutdown','SQLite_SQLiteExe','SQLite_Startup',
            'SQLite_TotalChanges','StringBetween','StringExplode',
            'StringInsert','StringProper','StringRepeat','StringTitleCase',
            'StringToHex','TCPIpToName','TempFile','TicksToTime','Timer_Diff',
            'Timer_GetIdleTime','Timer_GetTimerID','Timer_Init',
            'Timer_KillAllTimers','Timer_KillTimer','Timer_SetTimer',
            'TimeToTicks','VersionCompare','viClose','viExecCommand',
            'viFindGpib','viGpibBusReset','viGTL','viInteractiveControl',
            'viOpen','viSetAttribute','viSetTimeout','WeekNumberISO',
            'WinAPI_AbortPath','WinAPI_ActivateKeyboardLayout',
            ...
            'WinAPI_GetCapture','WinAPI_GetCaretBlinkTime','WinAPI_GetCaretPos',
            'WinAPI_GetCDType','WinAPI_GetClassInfoEx','WinAPI_GetClassLongEx',
            ...
            'WinAPI_GetCursor','WinAPI_GetCursorInfo','WinAPI_GetCursorSize',
            'WinAPI_GetDateFormat','WinAPI_GetDC','WinAPI_GetDCEx',
            'WinAPI_GetDefaultPrinter','WinAPI_GetDefaultUserProfileDirectory',
            'WinAPI_GetDesktopWindow','WinAPI_GetDeviceCaps',
            'WinAPI_GetDeviceDriverBaseName','WinAPI_GetDeviceDriverFileName',
            'WinAPI_GetDeviceGammaRamp','WinAPI_GetDIBColorTable',
            'WinAPI_GetDIBits','WinAPI_GetDiskFreeSpaceEx',
            'WinAPI_GetDlgCtrlID','WinAPI_GetDlgItem','WinAPI_GetDllDirectory',
            ...
            'WinAPI_GetKeyboardLayoutLocale','WinAPI_GetKeyboardState',
            'WinAPI_GetKeyboardType','WinAPI_GetKeyNameText',
            'WinAPI_GetKeyState','WinAPI_GetLastActivePopup',
            'WinAPI_GetLastError','WinAPI_GetLastErrorMessage',
            'WinAPI_GetLayeredWindowAttributes','WinAPI_GetLocaleInfo',
            'WinAPI_GetLogicalDrives','WinAPI_GetMapMode',
            'WinAPI_GetMemorySize','WinAPI_GetMessageExtraInfo',
            'WinAPI_GetModuleFileNameEx','WinAPI_GetModuleHandle',
            'WinAPI_GetModuleHandleEx','WinAPI_GetModuleInformation',
            'WinAPI_GetMonitorInfo','WinAPI_GetMousePos','WinAPI_GetMousePosX',
            'WinAPI_GetMousePosY','WinAPI_GetMUILanguage',
            'WinAPI_GetNumberFormat','WinAPI_GetObject','WinAPI_GetObjectID',
            'WinAPI_GetObjectInfoByHandle','WinAPI_GetObjectNameByHandle',
            'WinAPI_GetObjectType','WinAPI_GetOpenFileName',
            'WinAPI_GetOutlineTextMetrics','WinAPI_GetOverlappedResult',
            'WinAPI_GetParent','WinAPI_GetParentProcess',
            'WinAPI_GetPerformanceInfo','WinAPI_GetPEType',
            'WinAPI_GetPhysicallyInstalledSystemMemory','WinAPI_GetPixel',
            'WinAPI_GetPolyFillMode','WinAPI_GetPosFromRect',
            ...
            'WinAPI_OpenDesktop','WinAPI_OpenEvent','WinAPI_OpenFileById',
            'WinAPI_OpenFileDlg','WinAPI_OpenFileMapping','WinAPI_OpenIcon',
            ...
            'WinAPI_QueryDiskUsage','WinAPI_QueryDosDevice',
            'WinAPI_QueryInformationJobObject','WinAPI_QueryPerformanceCounter',
            'WinAPI_QueryPerformanceFrequency','WinAPI_QueryProcessCycleTime',
            'WinAPI_QueryProcessorUsage','WinAPI_RadialGradientFill',
            'WinAPI_ReadDirectoryChanges','WinAPI_ReadFile',
            'WinAPI_ReadProcessMemory','WinAPI_Rectangle','WinAPI_RectInRegion',
            'WinAPI_RectIsEmpty','WinAPI_RectVisible','WinAPI_RedrawWindow',
            'WinAPI_RegCloseKey','WinAPI_RegConnectRegistry',
            'WinAPI_RegCopyTree','WinAPI_RegCopyTreeEx','WinAPI_RegCreateKey',
            ...
            'WinAPI_SelectClipRgn','WinAPI_SelectObject','WinAPI_SendInput',
            ...
            'WinAPI_SetCursorSize','WinAPI_SetDCBrushColor',
            'WinAPI_SetDCPenColor','WinAPI_SetDefaultPrinter',
            'WinAPI_SetDeviceGammaRamp','WinAPI_SetDIBColorTable',
            'WinAPI_SetDIBits','WinAPI_SetDIBitsToDevice',
            'WinAPI_SetDllDirectory','WinAPI_SetEndOfFile',
            'WinAPI_SetEnhMetaFileBits','WinAPI_SetErrorMode','WinAPI_SetEvent',
            'WinAPI_SetFileAttributes','WinAPI_SetFileInformationByHandleEx',
            'WinAPI_SetFilePointer','WinAPI_SetFilePointerEx',
            'WinAPI_SetFileShortName','WinAPI_SetFileValidData',
            'WinAPI_SetFocus','WinAPI_SetFont','WinAPI_SetForegroundWindow',
            'WinAPI_SetFRBuffer','WinAPI_SetGraphicsMode',
            'WinAPI_SetHandleInformation','WinAPI_SetInformationJobObject',
            'WinAPI_SetKeyboardLayout','WinAPI_SetKeyboardState',
            'WinAPI_SetLastError','WinAPI_SetLayeredWindowAttributes',
            'WinAPI_SetLocaleInfo','WinAPI_SetMapMode',
            'WinAPI_SetMessageExtraInfo','WinAPI_SetParent','WinAPI_SetPixel',
            'WinAPI_SetPolyFillMode','WinAPI_SetPriorityClass',
            'WinAPI_SetProcessAffinityMask',
            ...
            'WinAPI_WaitForSingleObject','WinAPI_WaitSystemIdle',
            'WinAPI_WideCharToMultiByte','WinAPI_WidenPath',
            'WinAPI_WindowFromDC','WinAPI_WindowFromPoint','WinAPI_WordToShort',
            'WinAPI_Wow64EnableWow64FsRedirection','WinAPI_WriteConsole',
            'WinAPI_WriteFile','WinAPI_WriteProcessMemory','WinAPI_ZeroMemory',
        ...
        6 => array(
            ...
            'AutoIt3Wrapper_Res_Comment','AutoIt3Wrapper_Res_CompanyName',
            'Autoit3Wrapper_Res_Compatibility','AutoIt3Wrapper_Res_Description',
            'AutoIt3Wrapper_Res_Field','AutoIt3Wrapper_Res_File_Add',
            'AutoIt3Wrapper_Res_FileVersion',
            'AutoIt3Wrapper_Res_FileVersion_AutoIncrement',
            'AutoIt3Wrapper_Res_Fileversion_First_Increment',
            'AutoIt3Wrapper_Res_HiDpi','AutoIt3Wrapper_Res_Icon_Add',
            ...
            'AutoIt3Wrapper_Run_After_Admin','AutoIt3Wrapper_Run_Au3Check',
            'AutoIt3Wrapper_Run_Au3Stripper','Au3Stripper_Parameters',
            'AutoIt3Wrapper_Au3stripper_OnError','AutoIt3Wrapper_Run_Before',
            'AutoIt3Wrapper_Run_Before_Admin','AutoIt3Wrapper_Run_Debug',
            ...
            'AutoIt3Wrapper_ShowGui','AutoIt3Wrapper_Testing',
            ...
            'AutoIt3Wrapper_Versioning_Parameters','Tidy_ILC_Pos','Tidy_Off',
            'Tidy_On','Tidy_Parameters','EndRegion','Region'
            ),
        7 => array(
